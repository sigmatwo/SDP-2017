...
abstract class EnemyShipBuilding {
  ...
  protected def makeEnemyShip(typeOfShip: String): EnemyShip
  ...
  def orderTheShip(typeOfShip: String): EnemyShip = {
    val theEnemyShip: EnemyShip = makeEnemyShip(typeOfShip)
